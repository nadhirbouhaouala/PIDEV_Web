...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\NozelitesBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ReclamationBundle\\Entity')]);

$b->addDriver($c, 'NozelitesBundle\\Entity');
...
$a->setEntityNamespaces(['NozelitesBundle' => 'NozelitesBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'ReclamationBundle' => 'ReclamationBundle\\Entity']);
