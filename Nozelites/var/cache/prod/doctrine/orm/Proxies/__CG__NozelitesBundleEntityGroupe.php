 ...
 */
class Groupe extends \NozelitesBundle\Entity\Groupe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NozelitesBundle\\Entity\\Groupe' . "\0" . 'idGroupe', '' . "\0" . 'NozelitesBundle\\Entity\\Groupe' . "\0" . 'titre', '' . "\0" . 'NozelitesBundle\\Entity\\Groupe' . "\0" . 'description', '' . "\0" . 'NozelitesBundle\\Entity\\Groupe' . "\0" . 'autorisation'];
        }
