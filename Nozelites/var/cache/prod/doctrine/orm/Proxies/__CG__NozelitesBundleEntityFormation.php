 ...
 */
class Formation extends \NozelitesBundle\Entity\Formation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NozelitesBundle\\Entity\\Formation' . "\0" . 'idFormation', '' . "\0" . 'NozelitesBundle\\Entity\\Formation' . "\0" . 'titre', '' . "\0" . 'NozelitesBundle\\Entity\\Formation' . "\0" . 'idMembre', '' . "\0" . 'NozelitesBundle\\Entity\\Formation' . "\0" . 'Membre'];
        }
