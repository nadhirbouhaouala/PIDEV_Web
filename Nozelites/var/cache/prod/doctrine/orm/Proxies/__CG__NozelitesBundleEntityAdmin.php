 ...
 */
class Admin extends \NozelitesBundle\Entity\Admin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NozelitesBundle\\Entity\\Admin' . "\0" . 'idusr', '' . "\0" . 'NozelitesBundle\\Entity\\Admin' . "\0" . 'login', '' . "\0" . 'NozelitesBundle\\Entity\\Admin' . "\0" . 'mdp'];
        }
