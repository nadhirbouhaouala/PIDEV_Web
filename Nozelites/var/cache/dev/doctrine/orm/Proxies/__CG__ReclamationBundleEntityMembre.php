 ...
 */
class Membre extends \ReclamationBundle\Entity\Membre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'idusr', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'nom', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'prenom', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'tel', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'mail', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'login', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'mdp', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'age', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'formation', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'experience', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'type', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'image', '' . "\0" . 'ReclamationBundle\\Entity\\Membre' . "\0" . 'date'];
        }
