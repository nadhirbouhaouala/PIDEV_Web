 ...
 */
class ChasseurTalent extends \NozelitesBundle\Entity\ChasseurTalent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'idusr', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'nom', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'prenom', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'tel', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'mail', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'login', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'mdp', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'age', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'entreprise', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'image', '' . "\0" . 'NozelitesBundle\\Entity\\ChasseurTalent' . "\0" . 'date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChasseurTalent $proxy) {
