...
class __TwigTemplate_6969eed784033fe24651fb54a487cec18b953e3c84679a00d8bf706f08b53dcf extends \Twig\Template
{
    ...
    <div class=\"content-wrapper\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["rec"]) {
            ...
            if (($this->getAttribute($context["rec"], "selecteur", []) == "groupe")) {
                ...
                // line 54
                echo "                                        ";
            } elseif (($this->getAttribute($context["rec"], "selecteur", []) == "event")) {
                // line 55
                echo "                                            ";
                $context['_parent'] = $context;
                            ...
                            <table id=\"tableau\" class=\"table table-bordered table-striped\">
                                ...
                                {% for rec in R %}
                                    <tr>
                                        ...
                                        <td>  <a href=\"{{ path('AfficherNote',{'id':rec.idRecl}) }}\" class=\"button dark ripple-effect\">Note</a></td>
                                    </tr>
                                {% endfor %}
                                </tfoot>
                            </table>
...
", "@Reclamation/Back/ListReclamation.html.twig", "C:\\wamp64\\www\\3.2\\PIDEV\\PIDEV_Web\\Nozelites\\src\\ReclamationBundle\\Resources\\views\\Back\\ListReclamation.html.twig");
    }
}
