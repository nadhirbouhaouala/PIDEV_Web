...
class __TwigTemplate_d5006f23cdf688f26ec7228f02a5742c1ef23ca9c1ed5f2b8dde260d23fd18b7 extends \Twig\Template
{
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["offre"]) {
            // line 9
            echo "                ";
            if (($this->getAttribute($this->getAttribute($context["offre"], "idRecepteur", []), "idUsr", []) == ($context["id"] ?? $this->getContext($context, "id")))) {
                echo " ";
                // line 10
                echo "                    <li id=\"";
...
{% block content %}
    <div class=\"content\">
        <ul class=\"dashboard-box-list\">
            {%  for offre in offres %}
                {% if offre.idRecepteur.idUsr == id %} {#Id du membre connecté#}
                    <li id=\"{{ offre.id }}\">
                        <!-- Overview -->
...
", "@Offre/Default/listeOffresMembre.html.twig", "C:\\xampp\\htdocs\\PIDEV_Web\\Nozelites\\src\\OffreBundle\\Resources\\views\\Default\\listeOffresMembre.html.twig");
    }
}
