...
class __TwigTemplate_1003304785a835caad6518521dbaace1c6f00675583c445a9f104a67458bbd19 extends \Twig\Template
{
...
";
    ...
    public function block_vich_file_widget($context, array $blocks = [])
    {
        ...
        ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "file", []), 'widget');
        echo "
        ";
        // line 10
        if ($this->getAttribute(($context["form"] ?? null), "delete", [], "any", true, true)) {
            // line 11
            echo "        ";
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "delete", []), 'row');
            echo "
        ";
        }
        // line 13
        ...
        ";
        // line 14
        if (((isset($context["download_uri"]) || array_key_exists("download_uri", $context)) && ($context["download_uri"] ?? $this->getContext($context, "download_uri")))) {
            // line 15
            echo "        <a href=\"";
...
";
    ...
    public function block_vich_image_widget($context, array $blocks = [])
    {
        ...
        // line 37
        echo "        ";
        if (((($context["show_download_link"] ?? $this->getContext($context, "show_download_link")) && (isset($context["download_uri"]) || array_key_exists("download_uri", $context))) && ($context["download_uri"] ?? $this->getContext($context, "download_uri")))) {
            // line 38
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, ($context["download_uri"] ?? $this->getContext($context, "download_uri")), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return array (  208 => 40,  200 => 38,  197 => 37,  189 => 35,  187 => 34,  184 => 33,  178 => 31,  176 => 30,  172 => 29,  169 => 28,  167 => 27,  158 => 26,  148 => 23,  146 => 22,  137 => 21,  125 => 17,  117 => 15,  115 => 14,  112 => 13,  106 => 11,  104 => 10,  100 => 9,  97 => 8,  95 => 7,  86 => 6,  76 => 3,  74 => 2,  65 => 1,  55 => 26,  52 => 25,  50 => 21,  47 => 20,  45 => 6,  42 => 5,  40 => 1,);
    }
...
{% endspaceless %}
{% endblock %}
", "@VichUploader/Form/fields.html.twig", "D:\\xampp\\htdocs\\PIDEV_Web\\Nozelites\\vendor\\vich\\uploader-bundle\\Resources\\views\\Form\\fields.html.twig");
    }
}
