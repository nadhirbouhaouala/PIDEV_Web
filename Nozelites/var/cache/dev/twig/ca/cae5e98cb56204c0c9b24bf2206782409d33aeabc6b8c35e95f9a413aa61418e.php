...
class __TwigTemplate_c62e2b14270799f881b6bb0e777d88cfd321b647da329aee2d7fd75fe3b5a55c extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("@Nozelites/basefrontmembre.html.twig", "@Offre/Default/listeOffres.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["offre"]) {
            // line 9
            echo "                ";
            if (($this->getAttribute($this->getAttribute($context["offre"], "idEmetteur", []), "idUsr", []) == ($context["id"] ?? $this->getContext($context, "id")))) {
                echo " ";
                // line 10
                echo "                    <li id=\"";
...
{% block content %}
    <div class=\"content\">
        <ul class=\"dashboard-box-list\">
            {%  for offre in offres %}
                {% if offre.idEmetteur.idUsr == id %} {#Id du chasseur connecté#}
                    <li id=\"{{ offre.id }}\">
                        <!-- Overview -->
...
", "@Offre/Default/listeOffres.html.twig", "C:\\xampp\\htdocs\\PIDEV_Web\\Nozelites\\src\\OffreBundle\\Resources\\views\\Default\\listeOffres.html.twig");
    }
}
